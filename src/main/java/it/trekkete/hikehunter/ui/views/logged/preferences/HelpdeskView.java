...
@Route(value = "prefs/helpdesk", layout = MainLayout.class)
@PermitAll
public class HelpdeskView extends VerticalLayout{

    private final AuthenticatedUser authenticatedUser;

    public HelpdeskView(@Autowired AuthenticatedUser authenticatedUser) {
